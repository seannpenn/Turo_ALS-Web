...
@endphp
    @if($error != null)
        <div class="container text-center" style=" margin: 0px auto;">
            ...
            <div class="row">
                    <span style="color:#FF0000">Enroll</span><span style="color:#FF0000">NOW</span>
                
            </div>
            <div class="row">
                <div class="col align-self-center">
                    <img class="icons" src="{{ asset('images/tagline.png') }}" width="500" height="300">
                </div>
            </div>
        </div>
    @elseif(Auth::user()->student->enrollment->status == 'pending')
        <div class="container text-center" style="margin: 0 auto;">
            <div class="col align-self-center">
                <div class="row">
                    <div class="col align-self-center">
                        <img class="icons" src="{{ asset('images/loading.gif') }}" >
                        <h2>Enrollment status is pending.....</h2>
                    </div>
                </div>
            </div>
        </div>
