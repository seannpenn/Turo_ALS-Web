    ...
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5" id="picture">
                ...
                <span class="font-weight-bold">{{Auth::user()->teacher->teacher_fname}} {{Auth::user()->teacher->teacher_mname}} {{Auth::user()->teacher->teacher_lname}}</span>
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2" id="info">
                    <div class="col-md-12"><label class="labels">Date of birth: </label> {{Auth::user()->teacher->teacher_birth}}</div>
                    <div class="col-md-12"><label class="labels">Address: </label> {{Auth::user()->teacher->location->loc_id}}</div>
                </div>
                <br>
